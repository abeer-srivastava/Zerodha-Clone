...
function Footer() {
  return (
    <div className="container ">
      <div className="row border-top mt-5 fs-6">
        <div className="col">
          <img src="media/logo.svg" alt="" className="w-50" />
        ...
        <div className="col">
          ...
          <br />
          <a href=""className="text-muted text-decoration-none">Videos</a>
          <br />
          <a href=""className="text-muted text-decoration-none">Market overview</a>
          <br />
