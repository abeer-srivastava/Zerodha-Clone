            ...
            <div className="row  p-5">
                <div className="col-6 p-5" >
                    ...
                    <p className='text-muted'>No gimmicks, spam, "gamification", or annoying push notifications. High quality apps that you use at your pace, the way you like.
                          ...
                          <h2
                        className='mb-3 fs-4'>The Zerodha universe</h2>
                    <p className='text-muted'>Not just an app, but a whole ecosystem. Our investments in 30+ fintech startups offer you tailored services specific to your needs.</p>                    <h2 className='fs-4'>Do better with money</h2>
                ...
                <div className="col-6 p-5">
                    <img src="media/ecosystem.png" alt="ecosysytem" className='w-100' />
                    <div className='p-5'>
                     <a className=" mx-3"href="">Explore our Products</a>   
                     <a href="">Try Kite</a>
                    </div>
                </div>
            </div>
